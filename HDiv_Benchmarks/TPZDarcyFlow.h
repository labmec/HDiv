...
#ifndef TPZDarcyFlowH
#define TPZDarcyFlowH
 ...
 */
class TPZDarcyFlow : public TPZDiscontinuousGalerkin {
...
public:
    ...
    TPZDarcyFlow(int nummat, int dim);
    
    TPZDarcyFlow(int matid) : TPZRegisterClassId(&TPZDarcyFlow::ClassId),
