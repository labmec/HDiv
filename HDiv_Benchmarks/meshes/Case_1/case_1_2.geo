...
Point(3) = {100.0, 100.0, 0.0};
Point(4) = {0.0, 100.0, 0.0};
Point(5) = {0.0, 0.0, 100.0};
Point(6) = {100.0, 0.0, 100.0};
Point(7) = {100.0, 100.0, 100.0};
Point(8) = {0.0, 100.0, 100.0};


// Lower layer outlet points
Point(9) = {0.0, 0.0, 10.0};
Point(10) = {100.0, 0.0, 10.0};
Point(11) = {100.0, 100.0, 10.0};
Point(12) = {0.0, 100.0, 10.0};

// Fault boundary points
Point(13) = {0.0, 0.0, 80.0};
Point(14) = {100.0, 0.0, 20.0};
Point(15) = {100.0, 100.0, 20.0};
Point(16) = {0.0, 100.0, 80.0};

// Upper layer inlet points
Point(17) = {0.0, 0.0, 90.0};
Point(18) = {0.0, 100.0, 90.0};

//  layer inlet points JOSE
Point(19) = {100.0, 0.0, 90.0};
Point(20) = {100.0, 100.0, 90.0};

Point(21) = {100.0, 0.0, 80.0};
Point(22) = {100.0, 100.0, 80.0};
Point(23) = {0.0, 0.0, 20.0};
Point(24) = {0.0, 100.0, 20.0};
