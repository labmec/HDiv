...
// tool plane points
p1=newp; Point(p1) = {0.0, 0.0, 90.0};
p2=newp; Point(p2) = {100.0, 0.0, 90.0};
p3=newp; Point(p3) = {100.0, 100.0, 90.0};
p4=newp; Point(p4) = {0.0, 100.0, 90.0};
...
BooleanFragments{ Volume{66}; Delete; }{ Surface{168}; Delete; }
