...
Physical Surface("bc_out_front") = {30};
//+
Physical Surface("bc_out_right") = {32};
//+
Physical Surface("bc_out_back") = {34};
//+
Physical Surface("bc_out_left") = {36};
//+
Physical Surface("bc_inlet") = {62};
//+
Physical Surface("bc_front_1") = {44};
//+
Physical Surface("bc_front_2") = {56};
//+
Physical Surface("bc_right_1") = {46};
//+
Physical Surface("bc_right_2") = {58};
//+
Physical Surface("bc_back_1") = {48};
//+
Physical Surface("bc_back_2") = {60};
//+
Physical Surface("bc_left_1") = {50};
//+
Physical Surface("bc_left_2") = {162};
//+
