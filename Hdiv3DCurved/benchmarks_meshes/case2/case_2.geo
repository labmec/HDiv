...
Physical Line("AUXILIARY_LINE_65") = {frac_line_65};
...
Physical Line("AUXILIARY_LINE_70") = {frac_line_70};

frac_line_71= newl; Line(frac_line_71) = {p19, p47};
Physical Line("AUXILIARY_LINE_71") = {frac_line_71};

frac_line_72= newl; Line(frac_line_72) = {p19, p51};
Physical Line("AUXILIARY_LINE_72") = {frac_line_72};
...
Physical Line("AUXILIARY_LINE_78") = {frac_line_78};
...
Physical Line("AUXILIARY_LINE_83") = {frac_line_83};

frac_line_84= newl; Line(frac_line_84) = {p23, p45};
Physical Line("AUXILIARY_LINE_84") = {frac_line_84};

frac_line_85= newl; Line(frac_line_85) = {p23, p53};
Physical Line("AUXILIARY_LINE_85") = {frac_line_85};
...
Physical Line("FRACTURE_LINE_111") = {frac_line_111};

frac_line_112= newl; Line(frac_line_112) = {p31, p63};
Physical Line("FRACTURE_LINE_112") = {frac_line_112};

frac_line_113= newl; Line(frac_line_113) = {p32, p59};
Physical Line("FRACTURE_LINE_113") = {frac_line_113};

frac_line_114= newl; Line(frac_line_114) = {p32, p60};
Physical Line("FRACTURE_LINE_114") = {frac_line_114};

frac_line_115= newl; Line(frac_line_115) = {p32, p62};
Physical Line("FRACTURE_LINE_115") = {frac_line_115};

frac_line_116= newl; Line(frac_line_116) = {p33, p50};
Physical Line("FRACTURE_LINE_116") = {frac_line_116};

frac_line_117= newl; Line(frac_line_117) = {p33, p58};
Physical Line("FRACTURE_LINE_117") = {frac_line_117};

frac_line_118= newl; Line(frac_line_118) = {p33, p60};
Physical Line("FRACTURE_LINE_118") = {frac_line_118};

frac_line_119= newl; Line(frac_line_119) = {p34, p52};
Physical Line("FRACTURE_LINE_119") = {frac_line_119};

frac_line_120= newl; Line(frac_line_120) = {p34, p58};
Physical Line("FRACTURE_LINE_120") = {frac_line_120};

frac_line_121= newl; Line(frac_line_121) = {p34, p61};
Physical Line("FRACTURE_LINE_121") = {frac_line_121};

frac_line_122= newl; Line(frac_line_122) = {p34, p63};
Physical Line("FRACTURE_LINE_122") = {frac_line_122};

frac_line_123= newl; Line(frac_line_123) = {p35, p55};
Physical Line("FRACTURE_LINE_123") = {frac_line_123};

frac_line_124= newl; Line(frac_line_124) = {p35, p59};
Physical Line("FRACTURE_LINE_124") = {frac_line_124};

frac_line_125= newl; Line(frac_line_125) = {p35, p61};
Physical Line("FRACTURE_LINE_125") = {frac_line_125};

frac_line_126= newl; Line(frac_line_126) = {p44, p62};
Physical Line("FRACTURE_LINE_126") = {frac_line_126};

frac_line_127= newl; Line(frac_line_127) = {p46, p62};
Physical Line("FRACTURE_LINE_127") = {frac_line_127};

frac_line_128= newl; Line(frac_line_128) = {p49, p62};
Physical Line("FRACTURE_LINE_128") = {frac_line_128};

frac_line_129= newl; Line(frac_line_129) = {p51, p63};
Physical Line("FRACTURE_LINE_129") = {frac_line_129};

frac_line_130= newl; Line(frac_line_130) = {p53, p63};
Physical Line("FRACTURE_LINE_130") = {frac_line_130};

frac_line_131= newl; Line(frac_line_131) = {p54, p63};
Physical Line("FRACTURE_LINE_131") = {frac_line_131};

frac_line_132= newl; Line(frac_line_132) = {p56, p64};
Physical Line("FRACTURE_LINE_132") = {frac_line_132};

frac_line_133= newl; Line(frac_line_133) = {p57, p64};
Physical Line("FRACTURE_LINE_133") = {frac_line_133};

frac_line_134= newl; Line(frac_line_134) = {p58, p64};
Physical Line("FRACTURE_LINE_134") = {frac_line_134};

frac_line_135= newl; Line(frac_line_135) = {p59, p64};
Physical Line("FRACTURE_LINE_135") = {frac_line_135};

frac_line_136= newl; Line(frac_line_136) = {p60, p64};
Physical Line("FRACTURE_LINE_136") = {frac_line_136};
...
Physical Point("FRACTURE_POINT_15") = {p50};
Physical Point("FRACTURE_POINT_16") = {p52};
Physical Point("FRACTURE_POINT_17") = {p55};
Physical Point("FRACTURE_POINT_18") = {p56};
Physical Point("FRACTURE_POINT_19") = {p57};
Physical Point("FRACTURE_POINT_20") = {p58};
Physical Point("FRACTURE_POINT_21") = {p59};
Physical Point("FRACTURE_POINT_22") = {p60};
Physical Point("FRACTURE_POINT_23") = {p61};
Physical Point("FRACTURE_POINT_24") = {p62};
